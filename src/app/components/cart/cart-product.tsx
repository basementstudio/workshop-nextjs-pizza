  ...
  return (
    ...
    >
      <div className="flex w-[60%] flex-col gap-2 text-black  sm:justify-between ">
        ...
        <div className="text-xs uppercase leading-none text-black sm:text-2xl sm:leading-tight md:w-full md:leading-trim">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex h-6 items-center sm:h-12">
            ...
            <div className="ml-3 flex gap-2 sm:ml-6 sm:gap-3">
              <button
                className="flex h-6 w-6 items-center justify-center rounded-full border border-black bg-teal text-center font-display text-[16px] leading-trim text-black transition-colors ease-in better-hover:bg-cream disabled:opacity-70 sm:h-10 sm:w-10 sm:text-2xl  xl:h-12 xl:w-12 xl:border-2 xl:text-base"
          ...
          <div className="flex h-6 items-center justify-center text-xs leading-trim sm:h-12 sm:text-base">
            ...
            <button
              ...
              className="ml-auto flex font-bold uppercase transition-opacity ease-in better-hover:opacity-60"
            >
              Remove
            </button>
          </div>
